...
.. admonition:: Language-specific tools for big data
   ...
   .. tabs::
      ...
      .. tab:: R
         ...
         [Arrowhttps://arrow.apache.org/docs/r/index.html) (previously *disk.frame*) can deal with
         big arrays. Other tools include [data.tablehttps://cran.r-project.org/web/packages/data.table/vignettes/datatable-intro.html)
         and [bigmemoryhttps://cran.r-project.org/web/packages/bigmemory/index.html).
