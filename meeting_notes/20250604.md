...
- [Richel] The course is an introduction course.
  ...
  In a schedule, 1 of these 3 topics can still fit in.
    ...
    - [MOVED TO DAY 4] Suggest to remove 'Parallel':
        ...
        - [Richel] There is also a learner that wants to keep it in [the evaluation](https://github.com/UPPMAX/R-matlab-julia-HPC/blob/main/docs-mk/evaluations/20250324_r/README.md#question-5-which-future-training-topics-would-you-like-to-be-provided-by-the-training-hosts)
...
- Evaluations
    ...
    - [On GitHub](https://github.com/UPPMAX/R-matlab-julia-HPC/tree/main/docs-mk/evaluations/20250325_matlab)
...
- Evaluations
    ...
    - [On GitHub](https://github.com/UPPMAX/R-matlab-julia-HPC/tree/main/docs-mk/evaluations/20250326_julia)
