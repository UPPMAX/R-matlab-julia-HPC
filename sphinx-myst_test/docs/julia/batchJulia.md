...
Guides and documentation at: [HPC2N](http://www.hpc2n.umu.se/support), [UPPMAX](https://docs.uppmax.uu.se/cluster_guides/slurm/),
[LUNARC](https://lunarc-documentation.readthedocs.io/en/latest/manual/submitting_jobs/manual_basic_job/), and
